				...
				<div class="d-flex flex-column w-50 p-3">
					...
					<form:form action="/editing/comment/${comment.id}" method="POST" modelAttribute="comment">
						...
						<div class="d-flex flex-row justify-content-around m-3">
							...
							<a class="btns text-danger" href="/delete/comment/${comment.id}/${algo.id}">Delete</a>
							<a class="btns center"  href="/algo/details/${algo.id}">Cancel</a>
						</div>
					</form:form>
				</div>
<!-- 			</div> -->
...
<!-- 				<p class="bold text-light txt-underline text-center font-size">Comments</p> -->
<!-- 				<hr> -->
<%-- 				<c:choose> --%>
...
<%-- 							<span class="font-size txt-underline" >${algo.user.firstName} ${algo.user.lastName}</span> -  --%>
