...
import com.brianfair.interviewalgos.validators.UserValidation;
...
//	
	...
	public String home(Model model, HttpSession session)
	{
		...
		List<Algo> algos = algoService.getAllAlgos();
	...
	public String snakeGame(HttpSession session, Model model)
	{
		if (session.getAttribute("user_id") == null)
		{
			return "redirect:/";
...
//    
	...
	public String like(@PathVariable("id") Long algo_id, HttpSession session)
	{
		...
		this.algoService.like(usr, algo);
		return "redirect:/home";
	}
	...
	public String unlike(@PathVariable("id") Long algo_id, HttpSession session)
	{
		...
		User usr = this.userService.findUserById(user_id);
		Algo algo = this.algoService.findAlgoById(algo_id);
		this.algoService.unlike(usr, algo);
		return "redirect:/home";
	}
